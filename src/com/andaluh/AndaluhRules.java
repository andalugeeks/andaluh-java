...
public class AndaluhRules {
    ...
    private static final Pattern pattern_h_general = Pattern.compile("(?iu)(?<!c)(h)(\\w?)");
    private static final Pattern pattern_h_hua = Pattern.compile("(?iu)(?<!c)(h)(ua)");
    private static final Pattern pattern_h_hue = Pattern.compile("(?iu)(?<!c)(h)(u)(e)");
    private static final Pattern pattern_x_starting = Pattern.compile("(?iu)\\b(x)");
    private static final Pattern pattern_x = Pattern.compile("(?iu)([aeiouáéíóú])(x)([aeiouyáéíóú])");
    private static final Pattern pattern_ch = Pattern.compile("(?iu)ch");
    private static final Pattern pattern_gj = Pattern.compile("(?iu)(g(?=[eiéí])|j)([aeiouáéíóú])");
    private static final Pattern pattern_gue_gui = Pattern.compile("(?iu)(g)u([eiéí])");
    private static final Pattern pattern_guue_guui = Pattern.compile("(?iu)(g)(ü)([eiéí])");
    private static final Pattern pattern_guen = Pattern.compile("(?iu)(b)(uen)");
    private static final Pattern pattern_guel_gues = Pattern.compile("(?iu)(s?)(a?)(?<!m)(b)(ue)(l|s)");
    private static final Pattern pattern_v = Pattern.compile("(?iu)v");
    private static final Pattern pattern_nv = Pattern.compile("(?iu)nv");
    private static final Pattern pattern_ll = Pattern.compile("(?iu)ll");
    private static final Pattern pattern_l = Pattern.compile("(?iu)(l)([bcçgsdfghkmpqrtxz])");
    private static final Pattern pattern_psico_pseudo = Pattern.compile("(?iu)p(sic|siq|seud)");
    private static final Pattern pattern_vaf = Pattern.compile("(?iu)(c(?=[eiéíêî])|z|s)([aeiouáéíóúâêîôû])");
    private static final Pattern pattern_intervowel_d_end = Pattern.compile("(?iu)\\b([\\p{L}\\p{M}\\p{Nd}_]*?)([aií])(d)([oa])(s?)\\b");
    private static final Pattern pattern_eps_end = Pattern.compile("(?iu)\\b([\\p{L}\\p{M}\\p{Nd}_]+?)(e)(ps)\\b");
    private static final Pattern pattern_d_end = Pattern.compile("(?iu)\\b([\\p{L}\\p{M}\\p{Nd}_]+?)([aeiouáéíóú])(d)\\b");
    private static final Pattern pattern_s_end = Pattern.compile("(?iu)\\b([\\p{L}\\p{M}\\p{Nd}_]+?)([aeiouáéíóú])(s)\\b");
    private static final Pattern pattern_const_end = Pattern.compile("(?iu)\\b([\\p{L}\\p{M}\\p{Nd}_]+?)([aeiouáéíóú])([bcfgjklprtxz])\\b");
    private static final Pattern pattern_l_end = Pattern.compile("(?iu)\\b([\\p{L}\\p{M}\\p{Nd}_]+?)([aeiouáéíóú])(l)\\b");
    private static final Pattern pattern_digraph_special_1 = Pattern.compile("(?iu)([aeiouáéíóú])([lr])s(t)");
    private static final Pattern pattern_digraph_special_2 = Pattern.compile("(?iu)(tr|p)([ao])(?:ns|st)([bcçdfghjklmnpqstvwxyz])");
    private static final Pattern pattern_digraph_special_3 = Pattern.compile("(?iu)([aeiouáéíóú])([bdnr])(s)([bcçdfghjklmnpqrstvwxyz])");
    private static final Pattern pattern_digraph_special_4 = Pattern.compile("(?iu)([aeiouáéíóú])[djrstxz](l)");
    private static final Pattern pattern_digraph_general = Pattern.compile("(?iu)([aeiouáéíóú])(" + String.join("|", DIGRAPHS) + ")");
    private static final Pattern pattern_exception = Pattern.compile("(?iu)ç?[\\p{L}\\p{M}\\p{Nd}_]+\\b");
    private static final Pattern pattern_word_interaction = Pattern.compile("(?iu)(l\\b)(\\s)([bcçdfghjklmnñpqstvwxyz])");
    private static final Pattern pattern_vocal_tilde = Pattern.compile("(?iu)á|é|í|ó|ú");
